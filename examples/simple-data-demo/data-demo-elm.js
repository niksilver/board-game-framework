	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This code assumes the server is at http://localhost:8080')
					])),
				A2(
				$elm$html$Html$form,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('http://localhost:8080/g/'),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$value(model.draftGameID),
