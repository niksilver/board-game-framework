...
{
	if (region.X.aB === region.bF.aB)
	{
		return 'on line ' + region.X.aB;
	}
	return 'on lines ' + region.X.aB + ' through ' + region.bF.aB;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dl: 'hidden', c_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dl: 'mozHidden', c_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dl: 'msHidden', c_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dl: 'webkitHidden', c_: 'webkitvisibilitychange' }
		: { dl: 'hidden', c_: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {az: fragment, bQ: host, b6: path, b9: port_, cc: protocol, cd: query};
	});
...
var $author$project$BoardGameFramework$toUrlString = function (_v0) {
	...
	return addr.X + (portStr + ('/g/' + $author$project$BoardGameFramework$fromGameId(addr.bK)));
};
...
var $author$project$BoardGameFramework$withGameId = F2(
	function (gId, _v0) {
		var server = _v0;
		return {bK: gId, af: server.af, X: server.X};
	});
...
var $author$project$Main$init = F3(
	function (myId, url, key) {
		var fragStr = A2($elm$core$Maybe$withDefault, '', url.az);
		var _v0 = function () {
			var _v1 = $author$project$BoardGameFramework$gameId(fragStr);
			if (!_v1.$) {
				var id = _v1.a;
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(id),
					$author$project$Main$openCmd(id));
			} else {
				return _Utils_Tuple2(
					$elm$core$Maybe$Nothing,
		...
		return _Utils_Tuple2(
			{
				...
				aA: key,
				y: myId,
				n: A2($elm$core$Dict$singleton, myId, ''),
				w: url
			},
			cmd);
	});
...
var $author$project$Main$Body = F2(
	function (id, name) {
		return {ad: id, ag: name};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$bodyDecoder = A3(
								...
								var make = F5(
									function (to, from, num, time, body) {
										return $author$project$BoardGameFramework$Peer(
											{bx: body, di: from, aC: num, aH: time, bp: to});
									});
								var fromRes = A2(
									$elm$json$Json$Decode$decodeValue,
								...
								var make = F5(
									function (me, others, num, time, body) {
										return $author$project$BoardGameFramework$Receipt(
											{bx: body, bX: me, aC: num, b3: others, aH: time});
									});
								var bodyRes = A2(
									$elm$json$Json$Decode$decodeValue,
									A2($elm$json$Json$Decode$field, 'Body', bodyDecoder),
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$string(body.ad)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(body.ag))
			]));
};
...
var $author$project$Main$myName = function (model) {
	return A2(
		$elm$core$Maybe$withDefault,
		'',
		A2($elm$core$Dict$get, model.y, model.n));
};
		...
		switch (env.$) {
			case 0:
				...
				var players1 = A2(
					...
					model.y,
					$author$project$Main$myName(model));
				var insert = F2(
					function (cId, dict) {
						return A3($elm$core$Dict$insert, cId, '', dict);
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A3($elm$core$List$foldl, insert, players1, w.b3)
						}),
					$author$project$Main$sendCmd(
						{
							ad: model.y,
							ag: $author$project$Main$myName(model)
						}));
			case 2:
				var p = env.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A3($elm$core$Dict$insert, p.bx.ad, p.bx.ag, model.n)
						}),
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A3($elm$core$Dict$insert, j.dy, '', model.n)
						}),
					$author$project$Main$sendCmd(
						{
							ad: model.y,
			...
			case 4:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A2($elm$core$Dict$remove, l.dz, model.n)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var conn = env.a;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 0:
				var id = msg.a;
				var url2 = $elm$url$Url$toString(
					A2(withFragment, id, model.w));
				return _Utils_Tuple2(
					model,
					A2($elm$browser$Browser$Navigation$pushUrl, model.aA, url2));
			case 1:
				var req = msg.a;
				if (!req.$) {
					var url = req.a;
					return A3($author$project$Main$init, model.y, url, model.aA);
				} else {
					var url = req.a;
					return _Utils_Tuple2(
						model,
			...
			case 2:
				...
				if (_v2.$ === 1) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{L: '', bK: $elm$core$Maybe$Nothing, w: url}),
						A2($elm$random$Random$generate, $author$project$Main$GeneratedGameId, $author$project$BoardGameFramework$idGenerator));
				} else {
					var frag = _v2.a;
					var _v3 = $author$project$BoardGameFramework$gameId(frag);
					if (_v3.$ === 1) {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var gameId = _v3.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									L: $author$project$BoardGameFramework$fromGameId(gameId),
									bK: $elm$core$Maybe$Just(gameId),
									w: url
								}),
			...
			case 4:
				var url = model.w;
				var url2 = _Utils_update(
					url,
					{
						az: $elm$core$Maybe$Just(model.L)
					});
				return _Utils_Tuple2(
					model,
					A2(
			...
			case 6:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A3($elm$core$Dict$insert, model.y, model.ab, model.n)
						}),
					$author$project$Main$sendCmd(
						{ad: model.y, ag: model.ab}));
			default:
				var envRes = msg.a;
				if (!envRes.$) {
					var env = envRes.a;
					return A2(
						$author$project$Main$updateWithEnvelope,
						env,
						_Utils_update(
							model,
							{ay: $elm$core$Maybe$Nothing}));
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {cz: 'a', a4: 'atv', cC: 'ab', cD: 'cx', cE: 'cy', cF: 'acb', cG: 'accx', cH: 'accy', cI: 'acr', bu: 'al', bv: 'ar', cJ: 'at', a5: 'ah', a6: 'av', cL: 's', cP: 'bh', cQ: 'b', cR: 'w7', cS: 'bd', cT: 'bdt', aO: 'bn', cU: 'bs', aP: 'cpe', c0: 'cp', c1: 'cpx', c2: 'cpy', J: 'c', aR: 'ctr', aS: 'cb', aT: 'ccx', K: 'ccy', ax: 'cl', aU: 'cr', c4: 'ct', c5: 'cptr', c6: 'ctxt', dh: 'fcs', bH: 'focus-within', dj: 'fs', dk: 'g', bb: 'hbh', bc: 'hc', bO: 'he', bd: 'hf', bP: 'hfp', dm: 'hv', $7: 'ic', dq: 'fr', aX: 'lbl', ds: 'iml', dt: 'imlf', du: 'imlp', dv: 'implw', dw: 'it', dx: 'i', bV: 'lnk', ah: 'nb', bZ: 'notxt', dM: 'ol', dN: 'or', U: 'oq', dS: 'oh', b4: 'pg', b5: 'p', dT: 'ppe', dX: 'ui', B: 'r', dZ: 'sb', d_: 'sbx', d$: 'sby', d0: 'sbt', d2: 'e', d3: 'cap', d4: 'sev', ea: 'sk', aG: 't', ee: 'tc', ef: 'w8', eg: 'w2', eh: 'w9', ei: 'tj', a3: 'tja', ej: 'tl', ek: 'w3', el: 'w5', em: 'w4', en: 'tr', eo: 'w6', ep: 'w1', eq: 'tun', cp: 'ts', Y: 'clr', ew: 'u', bq: 'wc', cu: 'we', br: 'wf', cv: 'wfp', bs: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b5);
...
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d2);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.E)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d5.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.d5.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.B) + ('-' + ($elm$core$String$fromInt(pos.c3) + ('-' + ($elm$core$String$fromInt(pos.ct) + ('-' + $elm$core$String$fromInt(pos.bN)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dm, $mdgriffith$elm_ui$Internal$Style$classes.U)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dh, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a4, $mdgriffith$elm_ui$Internal$Style$classes.Y)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.a4, $mdgriffith$elm_ui$Internal$Style$classes.U)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.B) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.B) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aR) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aQ: closing, b3: _List_Nil, O: _List_Nil, C: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								b3: A2(
									$elm$core$List$cons,
									{aQ: '\n}', b3: _List_Nil, O: props, C: '@supports (' + (prop + (':' + (value + (') {' + parent.C))))},
									rendered.b3)
							});
					case 5:
						var selector = rule.a;
	...
	var renderIntermediate = function (_v0) {
		...
		return _Utils_ap(
			...
			$elm$core$String$concat(
				A2($elm$core$List$map, renderIntermediate, rule.b3)));
	};
	return $elm$core$String$concat(
		A2(
			$elm$core$List$map,
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.d2;
			...
			case 8:
				...
				var xSpacing = toGridLength(template.d5.a);
				var ySpacing = toGridLength(template.d5.b);
				var rows = function (x) {
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.E)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.d5.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.d5.a) + ';');
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.B) + (' / ' + ($elm$core$String$fromInt(position.B + position.bN) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.c3) + (' / ' + ($elm$core$String$fromInt(position.c3 + position.ct) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.B) + ('-' + ($elm$core$String$fromInt(position.c3) + ('-' + ($elm$core$String$fromInt(position.ct) + ('-' + $elm$core$String$fromInt(position.bN)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.aG + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.aG)))))))))), textAdjustment)
			]);
	});
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.d3, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.d3 + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.d3))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.d3 + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.aG + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.d3 + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.aG)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {bN: height / size, aj: size, cr: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cZ, adjustment.cO, adjustment.c8, adjustment.dB]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d2))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.K, $mdgriffith$elm_ui$Internal$Style$classes.cI])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.K, $mdgriffith$elm_ui$Internal$Style$classes.cG])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.cH])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.cF])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bc)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.br + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bd)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.cm : _Utils_ap(styled.cm, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.dn, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.cm : _Utils_ap(styled.cm, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.cm : _Utils_ap(rendered.cm, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.cz]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.cQ]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.dN]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.dM]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.dq]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ah, $mdgriffith$elm_ui$Internal$Style$classes.d2, $mdgriffith$elm_ui$Internal$Style$classes.cP]));
						}
					}())
				]),
			_List_fromArray(
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.cm);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.c4 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ax)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{dh: $elm$core$Maybe$Nothing, dm: $elm$core$Maybe$Nothing, dD: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dX, $mdgriffith$elm_ui$Internal$Style$classes.cL, $mdgriffith$elm_ui$Internal$Style$classes.d2]))),
...
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.a$, clr.aV, clr.aN, clr.aM);
};
var $mdgriffith$elm_ui$Element$toRgb = function (_v0) {
	...
	var b = _v0.c;
	var a = _v0.d;
	return {aM: a, aN: b, aV: g, a$: r};
};
var $author$project$UI$darken = F3(
	function (base, paint, degree) {
		...
		var adjust = function (channel) {
			...
			return paintCol - (degree * (paintCol - baseCol));
		};
...
var $author$project$UI$rgbHex2 = function (str) {
	var toInt = function (chr) {
		return $elm$core$Char$isDigit(chr) ? ($elm$core$Char$toCode(chr) - $elm$core$Char$toCode('0')) : ($elm$core$Char$isUpper(chr) ? ($elm$core$Char$toCode(chr) - $elm$core$Char$toCode('A')) : ($elm$core$Char$toCode(chr) - $elm$core$Char$toCode('a')));
	};
	var s2 = A2($elm$core$String$right, 1, str);
	var s1 = A2($elm$core$String$left, 1, str);
	var _v0 = _Utils_Tuple2(
		$elm$core$String$uncons(s1),
		$elm$core$String$uncons(s2));
	if ((!_v0.a.$) && (!_v0.b.$)) {
		var _v1 = _v0.a.a;
		var c1 = _v1.a;
		var _v2 = _v0.b.a;
		var c2 = _v2.a;
		return ((toInt(c1) * 16) + toInt(c2)) / 255;
	} else {
		return 0;
	}
};
var $author$project$UI$rgbHex = function (str) {
	var r = $author$project$UI$rgbHex2(
		A3($elm$core$String$slice, 0, 2, str));
	var g = $author$project$UI$rgbHex2(
		A3($elm$core$String$slice, 2, 4, str));
	var b = $author$project$UI$rgbHex2(
		A3($elm$core$String$slice, 4, 6, str));
	return A3($mdgriffith$elm_ui$Element$rgb, r, g, b);
};
var $author$project$UI$waterfall = $author$project$UI$rgbHex('68829e');
var $author$project$UI$white = A3($mdgriffith$elm_ui$Element$rgb, 1.0, 1.0, 1.0);
var $author$project$UI$miniPaletteWaterfall = function () {
	var closer = $author$project$UI$darken($author$project$UI$waterfall);
	return {
		a7: $author$project$UI$waterfall,
		ao: A2(closer, $author$project$UI$white, 0.7),
		ap: A2(closer, $author$project$UI$white, 0.9),
		aq: _List_Nil,
		ar: A2(closer, $author$project$UI$white, 0.5),
		as: A2(closer, $author$project$UI$white, 0.8),
		at: A2(closer, $author$project$UI$white, 0.5),
		au: _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A2(closer, $author$project$UI$white, 0.7))
			]),
		av: $author$project$UI$white,
		ai: A2(closer, $author$project$UI$white, 0.7),
		aG: $author$project$UI$white,
		es: $author$project$UI$white
	};
}();
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aT + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.K + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bV)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	});
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ew);
var $author$project$UI$link = function (desc) {
	return A2(
...
var $author$project$Main$viewFooter = function (model) {
	var url = model.w;
	var mp = $author$project$UI$miniPaletteWaterfall;
	var baseUrl = _Utils_update(
		url,
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color(mp.aG),
		...
		A2(
			...
			$author$project$UI$link(
				{
					ae: $mdgriffith$elm_ui$Element$text('Click here to try a new game'),
					w: $elm$url$Url$toString(baseUrl)
				})));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$size($author$project$UI$fontSize * size),
					$mdgriffith$elm_ui$Element$centerX
				]),
			$mdgriffith$elm_ui$Element$text(text));
	});
var $author$project$UI$thunderCloud = $author$project$UI$rgbHex('505160');
var $author$project$UI$miniPaletteThunderCloud = function () {
	var closer = $author$project$UI$darken($author$project$UI$thunderCloud);
	return {
		a7: $author$project$UI$thunderCloud,
		ao: A2(closer, $author$project$UI$white, 0.8),
		ap: A2(closer, $author$project$UI$white, 0.9),
		aq: _List_Nil,
		ar: A2(closer, $author$project$UI$white, 0.6),
		as: A2(closer, $author$project$UI$white, 0.9),
		at: A2(closer, $author$project$UI$white, 0.5),
		au: _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Main$DraftGameIdChange = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$JoinClick = {$: 4};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aT + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.K + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bZ)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$UI$button = function (desc) {
	...
	var attrs = function () {
		var _v0 = desc.bE;
		if (_v0) {
			return {a8: mp.as, a9: mp.at, bh: mp.au, a2: mp.av};
		} else {
			return {a8: mp.ao, a9: mp.ap, bh: mp.aq, a2: mp.ar};
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(attrs.a8),
				$mdgriffith$elm_ui$Element$Font$color(attrs.a2),
				$mdgriffith$elm_ui$Element$Border$color(attrs.a9),
				$mdgriffith$elm_ui$Element$Border$width(1),
				$mdgriffith$elm_ui$Element$Border$rounded(4),
				$mdgriffith$elm_ui$Element$padding(
				$author$project$UI$scaledInt(-1)),
				$mdgriffith$elm_ui$Element$mouseOver(attrs.bh)
			]),
		{
			ae: A2(
				$mdgriffith$elm_ui$Element$el,
				...
				$mdgriffith$elm_ui$Element$text(desc.ae)),
			b1: desc.bE ? desc.b1 : $elm$core$Maybe$Nothing
		});
};
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {cV: -box.cV, dA: -box.dA, dW: -box.dW, et: -box.et};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{p: _List_Nil, c: _List_Nil, i: _List_Nil, a: _List_Nil, am: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bZ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dT)),
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.ae),
			withDefaults);
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.aG),
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.b0)),
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.ae),
									...
									function () {
										if (textOptions.aG === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.aG === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.aG + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.p, textOptions.aG === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.ae) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$px($author$project$UI$fontSize * desc.bI)),
				$mdgriffith$elm_ui$Element$Background$color(mp.a7),
				$mdgriffith$elm_ui$Element$Font$color(mp.aG)
			]),
		{
			ae: A2(
			...
			ai: $elm$core$Maybe$Just(
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color(mp.ai)
						]),
					$mdgriffith$elm_ui$Element$text(desc.b8))),
			aG: desc.aG
		});
};
var $author$project$Main$joinEnabled = function (model) {
	var disconnected = !(!model.aw);
	var _v0 = model.bK;
	if (!_v0.$) {
		var gameId = _v0.a;
		var _v1 = $author$project$BoardGameFramework$gameId(model.L);
		if (!_v1.$) {
			var newGameId = _v1.a;
			return (!_Utils_eq(gameId, newGameId)) || disconnected;
		} else {
			return false;
		}
	} else {
...
var $author$project$Main$middleBlock = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
			$mdgriffith$elm_ui$Element$px(
				$author$project$UI$scaledInt(4)))
		]),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ax + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.K)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$UI$greenLight = function (text) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width(
				$mdgriffith$elm_ui$Element$px($author$project$UI$fontSize * 8)),
				$mdgriffith$elm_ui$Element$Font$center,
				$mdgriffith$elm_ui$Element$Border$rounded(15),
				$mdgriffith$elm_ui$Element$Border$width(0),
				$mdgriffith$elm_ui$Element$padding(
				$author$project$UI$scaledInt(-5))
			]),
		$mdgriffith$elm_ui$Element$text(text));
};
var $author$project$UI$redLight = function (text) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb, 1.0, 0.3, 0.3)),
				$mdgriffith$elm_ui$Element$Font$color(
...
var $author$project$Main$viewConnectivity = function (model) {
	var _v0 = model.aw;
	switch (_v0) {
		case 0:
			return $author$project$UI$greenLight('Connected');
		case 1:
			return $author$project$UI$redLight('Connecting');
		default:
			return $author$project$UI$redLight('Disconnected');
	}
};
var $author$project$UI$amberLight = function (text) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(
				A3($mdgriffith$elm_ui$Element$rgb, 1.0, 1.0, 0.3)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0)),
				$mdgriffith$elm_ui$Element$width(
				$mdgriffith$elm_ui$Element$px($author$project$UI$fontSize * 20)),
				$mdgriffith$elm_ui$Element$Font$center,
				$mdgriffith$elm_ui$Element$Border$rounded(15),
				$mdgriffith$elm_ui$Element$Border$width(0),
				$mdgriffith$elm_ui$Element$padding(
...
var $author$project$Main$viewError = function (model) {
	...
	if (!_v0.$) {
		if (!_v0.a.$) {
			var desc = _v0.a.a;
			return $author$project$UI$amberLight('Low level error: ' + desc);
		} else {
			var err = _v0.a.a;
			var desc = $elm$json$Json$Decode$errorToString(err);
			return ($elm$core$String$length(desc) > 20) ? $author$project$UI$amberLight(
				'JSON error: ' + (A2($elm$core$String$left, 20, desc) + '...')) : $author$project$UI$amberLight('JSON error: ' + desc);
		}
	} else {
		return $mdgriffith$elm_ui$Element$none;
	}
};
var $author$project$Main$viewJoin = function (model) {
	var mp = $author$project$UI$miniPaletteThunderCloud;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$spacing(
				$author$project$UI$scaledInt(3))
			]),
		_List_fromArray(
			[
				A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									{bI: 12, ae: 'The code for this game is', aZ: mp, b0: $author$project$Main$DraftGameIdChange, b8: 'Game code', aG: model.L}),
									$mdgriffith$elm_ui$Element$text(' '),
									$author$project$UI$button(
									{
										bE: $author$project$Main$joinEnabled(model),
										ae: 'Join',
										aZ: mp,
										b1: $elm$core$Maybe$Just($author$project$Main$JoinClick)
									})
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$alignRight]),
									$author$project$Main$viewConnectivity(model))
								]))
						]))),
				$author$project$Main$middleBlock,
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Tell others to join you by '),
						$mdgriffith$elm_ui$Element$text('typing the code into their box and hitting Join, or they can '),
						$mdgriffith$elm_ui$Element$text(' go to '),
						$author$project$UI$link(
						{
							ae: $mdgriffith$elm_ui$Element$text(
								$elm$url$Url$toString(model.w)),
							w: $elm$url$Url$toString(model.w)
						}),
						$mdgriffith$elm_ui$Element$text('. ')
					]))
			]));
};
var $author$project$Main$viewLobbyTop = function (model) {
	var mp = $author$project$UI$miniPaletteThunderCloud;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		_List_fromArray(
			[
				A2($author$project$UI$heading, 'Lobby demo', 3),
				$author$project$Main$viewJoin(model)
			]));
};
var $author$project$Main$ConfirmNameClick = {$: 6};
var $author$project$Main$DraftMyNameChange = function (a) {
	return {$: 5, a: a};
};
var $elm$core$String$trim = _String_trim;
var $author$project$Main$goodName = function (name) {
	return $elm$core$String$length(
		$elm$core$String$trim(name)) >= 3;
};
var $author$project$Main$viewMyName = F2(
	function (draftMyName, model) {
		var mp = $author$project$UI$miniPaletteWaterfall;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$UI$inputText(
							{bI: 12, ae: 'Your name', aZ: mp, b0: $author$project$Main$DraftMyNameChange, b8: 'Enter name', aG: draftMyName}),
							$mdgriffith$elm_ui$Element$text(' '),
							$author$project$UI$button(
							{
								bE: $author$project$Main$goodName(draftMyName),
								ae: 'Confirm',
								aZ: mp,
								b1: $elm$core$Maybe$Just($author$project$Main$ConfirmNameClick)
							})
						]))));
	});
var $author$project$Main$nicePlayerName = F3(
	function (myId, id, name) {
		return _Utils_ap(
			$author$project$Main$goodName(name) ? name : 'Unknown player',
			_Utils_eq(id, myId) ? ' (you)' : '');
	});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$px((($author$project$UI$fontSize * 3) / 2) | 0))
						]),
					$mdgriffith$elm_ui$Element$text(
						A3($author$project$Main$nicePlayerName, model.y, id, name)));
			},
			$elm$core$Dict$toList(model.n)));
	var heading = A2($author$project$UI$heading, 'Players', 2);
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Main$viewNameSelection = F2(
	function (draftMyName, model) {
		var mp = $author$project$UI$miniPaletteWaterfall;
		return A2(
			$mdgriffith$elm_ui$Element$row,
			...
			_List_fromArray(
				[
					A2($author$project$Main$viewMyName, draftMyName, model),
					$author$project$Main$middleBlock,
...
var $author$project$Main$view = function (model) {
	return {
		bx: $elm$core$List$singleton(
			A2(
				$author$project$UI$layout,
				$author$project$UI$miniPaletteWaterfall.a7,
				A2(
					$mdgriffith$elm_ui$Element$column,
					_List_Nil,
					_List_fromArray(
						[
							$author$project$Main$viewLobbyTop(model),
							A2($author$project$Main$viewNameSelection, model.ab, model),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{dr: $author$project$Main$init, dO: $author$project$Main$UrlChanged, dP: $author$project$Main$UrlRequested, eb: $author$project$Main$subscriptions, ex: $author$project$Main$update, ey: $author$project$Main$view});
