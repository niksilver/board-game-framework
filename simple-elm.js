...
{
	if (region.t.F === region.X.F)
	{
		return 'on line ' + region.t.F;
	}
	return 'on lines ' + region.t.F + ' through ' + region.X.F;
}
...
var $author$project$Main$init = function (clientId) {
	return _Utils_Tuple2(
		{
			U: {C: true, w: 27, D: 'Hello world!'},
			M: clientId,
			v: 'sample-game-id',
			E: _List_Nil
		},
...
var $author$project$Main$toMessage = function (v) {
	return $author$project$Main$Received(
		A2($elm$json$Json$Encode$encode, 0, v));
};
var $author$project$Main$subscriptions = function (model) {
	return $author$project$Main$incoming($author$project$Main$toMessage);
};
...
var $author$project$BoardGameFramework$close = function (cmder) {
...
var $author$project$Main$encoder = function (body) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'words',
				$elm$json$Json$Encode$string(body.D)),
				_Utils_Tuple2(
				'truth',
				$elm$json$Json$Encode$bool(body.C)),
				_Utils_Tuple2(
				'wholenumber',
				$elm$json$Json$Encode$int(body.w))
			]));
};
...
var $author$project$BoardGameFramework$toUrlString = function (_v0) {
	...
	return addr.t + (portStr + ('/g/' + $author$project$BoardGameFramework$fromGameId(addr._)));
};
...
var $author$project$BoardGameFramework$withGameId = F2(
	function (gId, _v0) {
		var server = _v0;
		return {_: gId, y: server.y, t: server.t};
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var cmd = function () {
					var _v1 = $author$project$BoardGameFramework$gameId(model.v);
					if (!_v1.$) {
						var gameId = _v1.a;
						return A3($author$project$BoardGameFramework$open, $author$project$Main$outgoing, $author$project$Main$server, gameId);
					} else {
			...
			case 5:
				return _Utils_Tuple2(
					model,
					A3($author$project$BoardGameFramework$send, $author$project$Main$outgoing, $author$project$Main$encoder, model.U));
			case 6:
				return _Utils_Tuple2(
					model,
					$author$project$BoardGameFramework$close($author$project$Main$outgoing));
			default:
				var env = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: A2($elm$core$List$cons, env, model.E)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$CloseClick = {$: 6};
var $author$project$Main$GameId = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$OpenClick = {$: 1};
var $author$project$Main$SendClick = {$: 5};
var $author$project$Main$Truth = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$WholeNumber = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Main$viewControls = function (model) {
	...
	var addrPrefix = function () {
		var _v0 = $author$project$BoardGameFramework$gameId('this-will-do');
		if (!_v0.$) {
			var gameId = _v0.a;
			return A2(
				$elm$core$String$dropRight,
				$elm$core$String$length('this-will-do'),
				$author$project$BoardGameFramework$toUrlString(
					A2($author$project$BoardGameFramework$withGameId, gameId, $author$project$Main$server)));
		} else {
			return '';
		}
	}();
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Main$GameId)
							]),
						_List_Nil),
						$elm$html$Html$text(' '),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$disabled(!openEnabled)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$CloseClick)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$value(model.U.D),
								$elm$html$Html$Events$onInput($author$project$Main$Words)
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(model.U.C),
								$elm$html$Html$Events$onCheck($author$project$Main$Truth)
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Whole number: ')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(model.U.w)),
								$elm$html$Html$Events$onInput($author$project$Main$WholeNumber)
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$elm$html$Html$text('}'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$SendClick)
							]),
						_List_fromArray(
							[
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Client ID ' + model.M)
					])),
			A2(
				$elm$core$List$cons,
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Messages appear here, latest first:')
						])),
				A2(
					$elm$core$List$map,
					function (e) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewHistory(model)
			]));
};
